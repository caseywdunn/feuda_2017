...
```{r result_sig, fig.cap="Phylogenetic results of Feuda. These results were parsed from thier Table 3."}

D %>%
ggplot( aes( Recoding, Dataset ) ) + 
	geom_tile( aes( fill = Result ) ) + 
	facet_wrap( ~ Model ) +
	ggtitle("Ctenophore-sister Support") +
	theme_classic()
