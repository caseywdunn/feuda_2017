...
Each new matrix was analyzed with phylobayes-mpi version 1.8. Analyses were run for 1000 generations, and a `r burnin` generation burnin applied. The resulting tree files and PP scores were parsed for display with the code in https://github.com/caseywdunn/feuda_2017/manuscript.rmd .
