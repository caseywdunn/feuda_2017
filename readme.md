...
Here are their paper highlights:
...
I reorganized the data in this table and color coded the cells to get a better view the general pattern of support for Porifera-sister. This reorganized table is presented below as Figure 2.
...
The strong conclusions the authors made based largely on Table 3 are therefore rest entirely on recoding the Whelan matrix and applying the CAT-GTR+G model. Even then, less than half (4/9) of these recoded Whelan CAT-GTR+G analyses (Figure 3, right panel, bottom right 9 cells) provide significant support for Porifera-sister.
